            ...
            <div class="card-wrapper">
                <div class="card">
                        ...
                        <div class="product-imgs">
                            <div class="img-display">
                                <div class="img-showcase">
                                    <img src="../images/p6/2.jpg">
                                    <img src="../images/p6/3.jpg" alt="shoe image">
                                    <img src="../images/p6/1.jpg" alt="shoe image">
                            ...
                            <div class="img-select">
                                ...
                                <div class="img-item">
                                    <a href="#" data-id="2">
                                        <img src="../images/p6/3.jpg"
                                            alt="shoe image">
                                    </a>
                                </div>
                                <div class="img-item">
                                    <a href="#" data-id="3">
                                        <img src="../images/p6/1.jpg"
                                            alt="shoe image">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="product-content">
                        <h2 class="product-title">Jet Black</h2>
                        <div class="product-detail">
                            <ul>
                                <li>Price: <span>$169.99</span></li>
                        ...
                        <div class="opt">
                            ...
                            <?php
                                $size = $_POST['size'];
                                $conn -> query("INSERT INTO `cart` (`pid`, `size`) VALUES ('p6', '$size')");
