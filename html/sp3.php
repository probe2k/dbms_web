            ...
            <div class="card-wrapper">
                <div class="card">
                        ...
                        <div class="product-imgs">
                            <div class="img-display">
                                <div class="img-showcase">
                                    ...
                                    <img src="../images/p3/3.jpg" alt="shoe image">
                                    <img src="../images/p3/1.jpg" alt="shoe image">
                    ...
                    <div class="product-content">
                        <h2 class="product-title">Camouflage</h2>
                        <div class="product-detail">
                            <ul>
                                <li>Price: <span>$149.99</span></li>
                                <li>Available: <span>in stock</span></li>
                                <li>Category: <span>High-ankle Sneakers</span></li>
                        ...
                        <div class="opt">
                            ...
                            <?php
                                $size = $_POST['size'];
                                $conn -> query("INSERT INTO `cart` (`pid`, `size`) VALUES ('p3', '$size')");
