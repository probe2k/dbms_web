            ...
            <div class="card-wrapper">
                <div class="card">
                        ...
                        <div class="product-imgs">
                            <div class="img-display">
                                <div class="img-showcase">
                                    ...
                                    <img src="../images/p2/3.jpg" alt="shoe image">
                                    <img src="../images/p2/1.jpg" alt="shoe image">
                    ...
                    <div class="product-content">
                        <h2 class="product-title">Molten Lava</h2>
                        <div class="product-detail">
                            <ul>
                                <li>Price: <span>$199.99</span></li>
                        ...
                        <div class="opt">
                            ...
                            <?php
                                $size = $_POST['size'];
                                $conn -> query("INSERT INTO `cart` (`pid`, `size`) VALUES ('p2', '$size')");
