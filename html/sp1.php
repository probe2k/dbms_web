            ...
            <div class="card-wrapper">
                <div class="card">
                        ...
                        <div class="product-imgs">
                            <div class="img-display">
                                <div class="img-showcase">
                                    ...
                                    <img src="../images/p1/3.jpg" alt="shoe image">
                                    <img src="../images/p1/1.jpg" alt="shoe image">
                    ...
                    <div class="product-content">
                        <h2 class="product-title">Art Tart</h2>
                        ...
                        <div class="opt">
                            ...
                            <?php
                                $size = $_POST['size'];
                                $conn -> query("INSERT INTO `cart` (`pid`, `size`) VALUES ('p1', '$size')");
